...
public:
	AdjListDirNetwork(ElemType es[], int vertexNum, int vertexMaxNum = DEFAULT_SIZE, // 以数组es[]为顶点数据,顶点个数为vertexNum
		WeightType infinit = (WeightType)DEFAULT_INFINITY);// infinit表示无穷大,边数为0构造有向网
